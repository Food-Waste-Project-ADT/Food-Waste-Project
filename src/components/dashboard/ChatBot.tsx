    ...
    <Sheet>
      <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
        <SheetTrigger asChild>
          <Button
            size="icon"
            className="h-12 w-12 rounded-full shadow-lg bg-[#0084FF] hover:bg-[#0077E6]"
      ...
      <SheetContent className="w-[90vw] sm:max-w-md p-0 flex flex-col h-[80vh] sm:h-full border-l border-gray-200 bg-white">
        <SheetHeader className="p-4 border-b border-gray-200 bg-white">
          <SheetTitle className="text-[#0084FF]">
            ...
            <div className="flex justify-start">
              <div className="max-w-[80%] rounded-lg p-3 bg-white shadow-sm">
                <div className="flex space-x-2">
                  <div
                    className="w-2 h-2 rounded-full bg-[#0084FF] animate-bounce"
        ...
        >
          <textarea
            ...
            className="flex-1 min-h-10 p-2 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-1 focus:ring-[#0084FF] focus:border-transparent"
            rows={1}
          />
          <Button
            type="submit"
            size="icon"
            className="bg-[#0084FF] hover:bg-[#0077E6]"
